...
with tab4:
    st.subheader("🏬 상업·업무용 부동산 실거래가 조회")
    st.caption(
        "국토교통부 실거래가 공개 API를 이용해 상업·업무용 부동산(근린생활시설, 업무시설 등) "
        "매매 실거래가를 조회합니다. 아파트처럼 단지명이 없고, 건물유형/건물주용도로 구분됩니다."
    )
